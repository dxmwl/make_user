		...
		<view class="header-content">
			...
			<nav class="nav-section">
				<ul class="nav-menu">
					...
					<li class="nav-item" :class="{active: activeTab === 'circle'}" @click="switchTab('circle')">
						<text>交流圈</text>
					</li>
					<li class="nav-item" :class="{active: activeTab === 'about'}" @click="switchTab('about')">
						<text>关于</text>
					</li>
				</ul>
